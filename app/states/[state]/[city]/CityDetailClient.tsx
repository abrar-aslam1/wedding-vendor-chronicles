...
export default function CityDetailClient({ state, city }: CityDetailClientProps) {
  ...
  const handleCategoryClick = (categorySlug: string) => {
    ...
    router.push(`/top-20/${categorySlug}/${city}/${state}`);
  };
  ...
  const handleAllVendorsClick = () => {
    router.push(`/top-20/wedding-vendors/${city}/${state}`);
  };
