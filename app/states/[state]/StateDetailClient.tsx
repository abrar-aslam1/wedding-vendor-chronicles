...
export default function StateDetailClient({ state }: StateDetailClientProps) {
  ...
  const handleCityClick = (city: string) => {
    ...
    router.push(routes.city(state, citySlug));
  };

  const handleAllVendorsClick = () => {
    router.push(`/top-20/wedding-vendors/all-cities/${state}`);
  };
