...
const MatchMeClient = () => {
  ...
  const { saving, savePreferences } = useBridePreferences();
    ...
    if (result.success) {
      ...
      try {
        ...
        const matchResponse = await fetch(
          `${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/calculate-cultural-matches`,
          {
            method: 'POST',
            headers: {
