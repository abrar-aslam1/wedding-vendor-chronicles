        ...
        <div className="container mx-auto px-4 py-12 mt-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Button onClick={() => router.push('/match-me')}>
                Retake Quiz
              </Button>
            </div>
          </div>
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex gap-3">
                  <Button asChild className="flex-1">
                    <Link href={routes.vendor(topMatch.vendor?.id || '')}>
                      View Full Profile
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2">
                          <Button asChild variant="default" size="sm">
                            <Link href={routes.vendor(match.vendor?.id || '')}>
                              View Profile
                            </Link>
                          </Button>
                ...
                excellentMatches.map((match, index) => (
                  <Card key={match.vendor?.id || index}>
                    <CardContent className="p-6">
                      ...
                      <Button asChild>
                        <Link href={routes.vendor(match.vendor?.id || '')}>View Profile</Link>
                      </Button>
                    </CardContent>
                  </Card>
                ))
...
export default MatchResultsClient;
