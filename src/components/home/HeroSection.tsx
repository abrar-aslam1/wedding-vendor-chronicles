...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen md:min-h-[80vh] lg:min-h-[85vh] flex items-center bg-gradient-to-br from-wedding-light to-wedding-secondary py-8 md:py-12 lg:py-0">
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="md:max-w-4xl md:mx-auto lg:max-w-none lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
          <div className="space-y-8 md:space-y-10 text-center md:text-center lg:text-left max-w-2xl mx-auto md:mx-auto lg:mx-0 lg:max-w-none">
            <div className="space-y-6">
              <h2 className="font-body text-wedding-primary text-sm md:text-lg lg:text-lg uppercase tracking-wider mb-6 md:mb-6 lg:mb-4 lg:animate-fade-in">
                DISCOVER YOUR DREAM WEDDING TEAM
              </h2>
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-wedding-text leading-relaxed md:leading-tight lg:leading-tight">
                Find the Perfect Vendors
                <br />
                for Your <span className="text-wedding-primary">Special Day</span>
              </h1>
            </div>
            
            <p className="font-body text-xl md:text-xl lg:text-2xl text-wedding-text/80 max-w-lg mx-auto md:mx-auto lg:mx-0 lg:max-w-none">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center md:justify-center lg:justify-start mt-8 md:mt-10 lg:mt-12">
              <div className="text-center md:text-center lg:text-left">
                <p className="text-wedding-text/70 text-sm mb-2 lg:text-base">
                  Are you a wedding vendor?
                </p>
                <Button
                  onClick={handleListBusiness}
                  size="lg"
                  className="bg-wedding-primary hover:bg-wedding-primary/90 text-white px-8 py-3 lg:px-12 lg:py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 lg:text-lg"
                >
          ...
          <div className="mt-8 md:mt-12 lg:mt-0">
            <div className="max-w-xl md:max-w-2xl lg:max-w-2xl backdrop-blur-sm bg-white/90 p-6 md:p-8 lg:p-10 rounded-2xl shadow-2xl mx-auto md:mx-auto lg:mx-0 border border-white/50">
