...
export const HeroSection = () => {
  return (
    <section className="relative h-[600px] bg-gradient-to-br from-wedding-primary via-wedding-accent to-wedding-secondary overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-wedding-primary/90 via-wedding-accent/85 to-wedding-secondary/80"></div>
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex gap-4">
            <Button 
              size="lg" 
              variant="default" 
              className="bg-white text-wedding-primary hover:bg-wedding-light hover:text-wedding-primary transition-colors duration-300 font-medium"
            >
              Browse Vendors
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-white text-white hover:bg-white/20 hover:border-white/90 backdrop-blur-sm transition-colors duration-300 font-medium"
            >
              Get Started
            </Button>
          </div>
      ...
      {/* Decorative shapes */}
      <div className="absolute -bottom-16 -right-16 w-64 h-64 bg-white/15 rounded-full blur-3xl"></div>
      <div className="absolute -top-8 -left-8 w-48 h-48 bg-white/15 rounded-full blur-2xl"></div>
    </section>
  );
};