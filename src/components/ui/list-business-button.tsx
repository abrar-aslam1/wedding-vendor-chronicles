...
export const ListBusinessButton = () => {
  return (
    <div className="relative h-10">
      <button className="flex items-center justify-around h-10 px-4 bg-yellow-300 cursor-pointer shadow-[4px_6px_0px_black] border-4 border-black rounded-xl relative overflow-hidden z-10 transition-all duration-250 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_3px_0px_black] active:saturate-75 group">
        <div className="relative flex justify-start items-center overflow-hidden max-w-[35%] text-sm font-semibold">
        ...
        <div className="p-1 ml-2 border-2 border-black rounded-full bg-pink-300 relative overflow-hidden transition-all duration-250 group-hover:translate-x-[5px] group-active:translate-x-[8px] z-10">
