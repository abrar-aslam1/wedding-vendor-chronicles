...
export default function States() {
  return (
    <>
      <SEOHead 
        customTitle="Browse Wedding Vendors by State" 
        customDescription="Find the perfect wedding vendors in your state. Browse our comprehensive directory of wedding professionals across the United States."
        canonicalUrl={`${window.location.origin}/states`}
      />
      <MainNav />
