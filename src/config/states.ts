...
export const ALL_STATES: StateInfo[] = [
  // South
  { code: 'AL', name: 'Alabama', slug: 'alabama', region: US_REGIONS.SOUTH, majorCities: ['Birmingham', 'Montgomery', 'Mobile'], isActive: true, weddingSeasonPeak: 'Spring/Fall', popularVenueTypes: ['Historic Venues', 'Garden Venues', 'Rustic Barns'] },
  ...
  { code: 'FL', name: 'Florida', slug: 'florida', region: US_REGIONS.SOUTH, majorCities: ['Miami', 'Orlando', 'Tampa'], isActive: true, weddingSeasonPeak: 'Winter/Spring', popularVenueTypes: ['Beach Venues', 'Resort Venues', 'Garden Venues'] },
  { code: 'GA', name: 'Georgia', slug: 'georgia', region: US_REGIONS.SOUTH, majorCities: ['Atlanta', 'Savannah', 'Augusta'], isActive: true, weddingSeasonPeak: 'Spring/Fall', popularVenueTypes: ['Historic Venues', 'Garden Venues', 'Rustic Barns'] },
  ...
  { code: 'TX', name: 'Texas', slug: 'texas', region: US_REGIONS.SOUTH, majorCities: ['Dallas', 'Houston', 'Austin'], isActive: true, weddingSeasonPeak: 'Spring/Fall', popularVenueTypes: ['Rustic Barns', 'Historic Venues', 'Outdoor Venues'] },
  ...
  { code: 'AZ', name: 'Arizona', slug: 'arizona', region: US_REGIONS.WEST, majorCities: ['Phoenix', 'Tucson', 'Mesa'], isActive: true, weddingSeasonPeak: 'Winter/Spring', popularVenueTypes: ['Desert Venues', 'Resort Venues', 'Outdoor Venues'] },
  { code: 'CA', name: 'California', slug: 'california', region: US_REGIONS.WEST, majorCities: ['Los Angeles', 'San Francisco', 'San Diego'], isActive: true, weddingSeasonPeak: 'Year-round', popularVenueTypes: ['Beach Venues', 'Vineyard Venues', 'Garden Venues'] },
  { code: 'CO', name: 'Colorado', slug: 'colorado', region: US_REGIONS.WEST, majorCities: ['Denver', 'Colorado Springs', 'Boulder'], isActive: true, weddingSeasonPeak: 'Summer/Fall', popularVenueTypes: ['Mountain Venues', 'Rustic Barns', 'Outdoor Venues'] },
  ...
  { code: 'NY', name: 'New York', slug: 'new-york', region: US_REGIONS.NORTHEAST, majorCities: ['New York City', 'Buffalo', 'Albany'], isActive: true, weddingSeasonPeak: 'Summer/Fall', popularVenueTypes: ['Historic Venues', 'Vineyard Venues', 'Unique Venues'] },
  ...
  // Midwest
  { code: 'IL', name: 'Illinois', slug: 'illinois', region: US_REGIONS.MIDWEST, majorCities: ['Chicago', 'Springfield', 'Peoria'], isActive: true, weddingSeasonPeak: 'Summer/Fall', popularVenueTypes: ['Historic Venues', 'Garden Venues', 'Urban Venues'] },
