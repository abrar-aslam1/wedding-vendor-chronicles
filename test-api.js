// Test script to verify the search-vendors API is working
const testSearchAPI = async () => {
  ...
  console.log('🧪 Testing search-vendors API...');
  console.log('📦 Test payload:', testPayload);
  
  try {
    const response = await fetch(`${supabaseUrl}/functions/v1/search-vendors`, {
      method: 'POST',
      headers: {
